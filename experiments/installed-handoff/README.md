...
The updater defers rather than discarding their state. The owner’s 15 legacy
mod files have not been blanket-opted-in; their audit is bead 29v.2.

Core state uses schema 1. An incompatible core state or host protocol change
...
Validation also passed: 188 BEAM tests; 96 Swift tests (2 optional tests skipped);
7 actual-release/protocol tests; 5 updater tests; installer icon-isolation gates.
