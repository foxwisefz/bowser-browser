defmodule BowserBrain.ModRevision do
  ...
  def allowed?(path) when is_binary(path) do
    Regex.match?(
      ~r/^(sites\/[A-Za-z0-9_-][A-Za-z0-9._-]*\/[A-Za-z0-9_-][A-Za-z0-9._-]*\.(css|js)|mods\/[A-Za-z0-9_-][A-Za-z0-9._-]*\.ex|app-mods\/com\.gezim\.bowser\.site\.[0-9a-f]{16}\/[A-Za-z0-9_-][A-Za-z0-9._-]*\.(css|js))(\.off)?$/,
      path
